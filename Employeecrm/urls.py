...
urlpatterns = [
    ...
    path('emp/add/',views.EmployeeView.as_view(),name="emp-add"),
    path('emp/all/',views.EmployeeListView.as_view(),name="emp-all"),
    path("employees/<int:pk>",views.EmployeeDetailVeiw.as_view(),name="emp-detail"),
